...
public class Pic {
    ...
    public static void main(String[] args) {
        ...
        BufferedImage d = tt.loadImageLocal(path01+"幻灯片001.jpg");
        BufferedImage b = tt.loadImageLocal(path01+"幻灯片002.jpg");
        //往图片上写文件
        //tt.writeImageLocal("E:\\ploanshare\\2\\22.jpg", tt.modifyImage(d, "000000", 90, 90));

        tt.writeImageLocal(path02+"out.jpg", tt.modifyImagetogeter(b, d));
        //将多张图片合在一起
